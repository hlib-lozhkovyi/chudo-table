export const BASE_CLASS = 'chudo';

export const containerClassName = BASE_CLASS + '';

export const containerBorderClassName = BASE_CLASS + '--border';
export const containerRoundedClassName = BASE_CLASS + '--rounded';
...
export const paginationBorderClassName = paginationClassName + '--border';

export const paginationMetaClassName = paginationClassName + '__meta';

export const paginationCaptionClassName = paginationMetaClassName + '__caption';
export const paginationCaptionNumberClassName = paginationMetaClassName + '__number';

export const paginationNavigationClassName = paginationMetaClassName + '__navigation';
export const paginationNavigationItemClassName = paginationNavigationClassName + '__item';
export const paginationNavigationPageClassName = paginationNavigationItemClassName + '__page';
